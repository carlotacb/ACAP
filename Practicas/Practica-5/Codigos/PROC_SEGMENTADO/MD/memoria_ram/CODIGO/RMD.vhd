...
signal dirlectu: integer range 0 to num_contenedores_Elogico_D-1; -- registrar direccion de lectura
...
begin
	...
	datoL_local <= ram(dirlectu) after retlecMD;
end rtl;
